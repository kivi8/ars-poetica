...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION_EXPLAIN'	=> 'Určuje, mají-li uživatelé okamžitý přístup k&nbsp;fóru, nebo musí registraci účtu nejprve potvrdit. Lze také zcela zakázat nové registrace.  <em>Abyste mohli používat aktivaci uživatelem nebo administrátorem, musíte mít na fóru povolené posílání emailů</em>, které najdete v “Nastavení emailu” na záložce “Obecné”.',
  'ACC_ACTIVATION_WARNING'		=> 'Pamatujte, že aktuálně vybraný způsob aktivace vyžaduje, aby bylo na fóru povolené posílání emailů, jinak budou registrace zakázané. Doporučujeme vám, abyste si vybrali jiný způsob aktivace, nebo znovu povolili emaily.',
...
// Contact Settings
$lang = array_merge($lang, array(
	'ACP_CONTACT_SETTINGS_EXPLAIN'		=> 'Můžete polovit nebo zakázat stránku s kontakty a také nastavit text, který se na ni zobrazí.',

	'CONTACT_US_ENABLE'				=> 'Povolit stránku s kontakty',
	'CONTACT_US_ENABLE_EXPLAIN'		=> 'Stránka s kontakty umožňuje uživatelům poslat email administrátorům fóra',
...
$lang = array_merge($lang, array(
	...
	'CONTACT_EMAIL_NAME_EXPLAIN'	=> 'Toto je kontaktní jméno, které uvidí příjemci emailů. Pokud nechcete kontaktní jméno používat, nechte pole prázdné.',
