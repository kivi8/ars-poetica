...
$lang = array_merge($lang, array(
  ...
  'BACKUP_NOTICE'					=> 'Proveďte, prosím, zálohu vašeho fóra pro případ, že by se během aktualizace objevil nějaký problém.',
	...
	<p>phpBB3.1 lze spustit na těchto databázích:</p>
	<ul>
  ...
  'INST_ERR_DB_NO_ERROR'		=> 'Žádná chybová zpráva',
	...
	'INST_ERR_DB_NO_SQLITE3'	=> 'Verze rozšíření SQLite, kterou máte nainstalovanou, je zastaralá a je potřeba ji aktualizovat nejméně na verzi 3.6.15.',
	...
	'PHP_JSON_SUPPORT_EXPLAIN'		=> '<strong>Požadováno</strong> - Pro správnou funkci phpBB musí být dostupné rozšíření PHP JSON.',
	...
	'PHP_SETTINGS_EXPLAIN'			=> '<strong>Povinné</strong> – Musíte mít přinejmenším verzi PHP 5.3.3 pro instalaci phpBB. Pokud je <var>safe mode</var> zobrazen níže, vaše instalace PHP má tento režim zapnutý. Toto může přinést určitá omezení při vzdálené administraci a podobných funkcí.',
	...
	'PHP_VERSION_REQD'				=> 'Verze PHP >= 5.3.3',
	...
	'SELECT_FORUM_GA'			=> 'V phpBB 3.1 jsou globální oznámení připojeny k fórům. Vyberte fórum pro vaše současná globální oznámení (může být přesunuto později):',
  'SELECT_LANG'				=> 'Vyberte jazyk',
	...
	'STAGE_CREATE_TABLE_EXPLAIN' => 'Databázové tabulky pro phpBB 3.1 byly vytvořeny a naplněny základními daty. Pokračujte na další krok pro dokončení instalace phpBB.',
	...
	'SUPPORT_BODY'				=> '</p><p>Plná podpora je poskytována na <a href="http://www.phpbb.com/community/viewforum.php?f=466">phpBB 3.1.x Support Fóru na phpBB.com</a> nebo na <a href="http://www.phpbb.cz/viewforum.php?f=77">českém fóru podpory phpBB.cz</a>.<br />Rádi vám pomůžeme s:<ul><li>instalací</li><li>nastavením</li><li>technickými dotazy</li><li>potížemi souvisejícími s&nbsp;možnými chybami v&nbsp;softwaru</li><li>aktualizacemi z předchozích RC verzí na poslední stabilní verzi</li><li>převodem z phpBB 3.0.x na phpBB 3.1.x</li><li>převodem z jiných systémů pro fóra(navštivte <a href="http://www.phpbb.com/community/viewforum.php?f=65">Convertors Forum/ Fórum konvertorů na phpBB.com</a>)</li></ul>S problémy, které se tykají Rozšíření (Extensions), se obraťte na autora v&nbsp;odpovídajícím tématu na <a href="http://www.phpbb.com/community/viewforum.php?f=451">Fóru rozšíření</a>.<br />S problémy, které se týkají stylů, obrázků nebo šablon, navštivte <a href="http://www.phpbb.com/community/viewforum.php?f=471">Fórum stylů</a>.</p><p>Pro další podporu se koukněte na <a href="http://www.phpbb.com/support/documentation/3.0/quickstart/">Uživatelskou příručku</a> a <a href="http://www.phpbb.com/support/documentation/3.0/">online dokumentaci</a> (oboje v&nbsp;angličtině).</p><p>Abyste se ujistili, že máte poslední verzi fóra a neujdou vám žádné novinky ze světa phpBB, můžete se přihlásit k <a href="http://www.phpbb.com/support/">odebírání novinek přes e-mail</a>.',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'Všechny soubory jsou shodné s&nbsp;nejnovější verzí phpBB.',
	...
	'DATABASE_UPDATE_COMPLETE'			=> 'Aktualizace databáze byla dokončena!',
	'DATABASE_UPDATE_CONTINUE'			=> 'Pokračovat v aktualizaci databáze.',
	...
	'DATABASE_UPDATE_NOT_COMPLETED'		=> 'Aktualizace databáze ještě neskončila.',
	...
	'ERROR'						=> 'Chyba',
	'EVERYTHING_UP_TO_DATE'		=> 'Máte nainstalovanou poslední verzi phpBB. Nyní se můžete <a href="%1$s">přihlásit na vaše fórum</a> a zkontrolovat, zda všechno funguje tak jak má. Nezapomeňte smazat, přejmenovat nebo přesunout adresář “install”! Pošlete nám, prosím, z modulu <a href="%2$s">Poslat statistiky</a>, který naleznete v administraci vašeho fóra, informace o vašem serveru a nastavení vašeho fóra.',
	...
	'FILES_DELETED_EXPLAIN'			=> 'Následující soubory v nové verzi neexistují. Tyto soubory musíte z vaší instalace (serveru) smazat.',
	...
	'SHOW_DIFF_DELETED'			=> 'Zobrazit obsah souboru',
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<p>Prosím, přečtěte si oznámení o&nbsp;vydání nejnovější verze před pokračováním v&nbsp;aktualizaci, oznámení může obsahovat mnoho užitečných informací. Také obsahuje odkazy na stáhnutí a changelog.</p>
      ...
      <li>Přejděte na <a href="https://www.phpbb.com/downloads/" title="https://www.phpbb.com/downloads/">phpBB.com – soubory k stáhnutí</a> a stáhněte archiv "Automatic Update Package".<br /><br /></li>
		...
		<strong><a href="%1$s" title="%1$s">Nyní začněte s&nbsp;instalací zadáním cesty k&nbsp;složce install/ do prohlížeče</a>.</strong><br />
		<br />
	...
	'UPDATE_FILE_SUCCESS'			=> 'Aktualizace souborů proběhla úspěšně',
