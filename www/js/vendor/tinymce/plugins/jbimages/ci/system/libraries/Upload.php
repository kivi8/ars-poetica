	...
	// Is $_FILES[$field] set? If not, no reason to continue.
		...
		if ( ! @copy($this->file_temp, $this->upload_path.$this->file_name))
		{
			if ( ! @move_uploaded_file($this->file_temp, $this->upload_path.$this->file_name))
			{
                ...
                $path = pathinfo($this->upload_path.$this->file_name);
                
                $this->image_shrink($this->upload_path.$this->file_name, $path['dirname'].'/'.$path['filename'].'-min.'.$path['extension'], 750, 750);
...
private function image_shrink($file_in, $file_out, $max_x, $max_y = 0) {
