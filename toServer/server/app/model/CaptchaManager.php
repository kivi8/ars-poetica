...
class CaptchaManager extends \Nette\Object{
    ...
    /**
     * Generate random captcha question, returns only question
     * @return string
     */
    ...
    public function getCaptchaImage(){
        ...
        $image = Image::fromBlank($lenght, 40, Image::rgb(255, 255, 255));
        
        $image->ttfText(14, 0, 2, 30, Image::rgb(0, 0, 0), __DIR__.'/OpenSans-Semibold.ttf' ,$string );
...
class QuestionCaptchaManager{    
    ...
    private function tomorrow(){    
        ...
        return ['Pokud je dnes '.$this->days[$randomKey].' zítra bude ?', $randomKey == 7?$this->days[1]:$this->days[$randomKey++], ''];
