<?php
// source: /var/www/clients/client3/web28/web/app/presenters/templates/Homepage/creativeCommons.latte

class Templatedc9c36534f0286d043689154fdc0f603 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('b15a25f0db', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lbd9a7c7b2f0_title')) { function _lbd9a7c7b2f0_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb3457d20caf_content')) { function _lb3457d20caf_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
