<?php
// source: /var/www/clients/client3/web28/web/app/presenters/templates/Article/section.latte

class Template7d9cd8a93898bed19858703c03a577bd extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('dcdac98470', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lbecbe2aac2a_title')) { function _lbecbe2aac2a_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbd9c79a4c03_content')) { function _lbd9c79a4c03_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><ol class="breadcrumb">
  <li>
