<?php
// source: /var/www/clients/client3/web28/web/app/AdminModule/templates/User/default.latte

class Template5e55bb570080ece0cf3266579544d045 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('98bce673f8', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb58c2f5b2ab_title')) { function _lb58c2f5b2ab_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lba4b4e0ea94_content')) { function _lba4b4e0ea94_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
 ?>
...
// block _users
//
if (!function_exists($_b->blocks['_users'][] = '_lb84dd24866e__users')) { function _lb84dd24866e__users($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('users', FALSE)
