<?php
// source: /var/www/clients/client3/web28/web/app/AdminModule/templates/../../presenters/templates/@layout.latte

class Template69e12b4a1605af3a727c73840b989e69 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('46784fe109', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb49a305f6e9_scripts')) { function _lb49a305f6e9_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block _menu
//
if (!function_exists($_b->blocks['_menu'][] = '_lb761c60aa7d__menu')) { function _lb761c60aa7d__menu($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('menu', FALSE)
...
// block _flashMessage
//
if (!function_exists($_b->blocks['_flashMessage'][] = '_lbee6348c4ac__flashMessage')) { function _lbee6348c4ac__flashMessage($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('flashMessage', FALSE)
