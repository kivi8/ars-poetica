<?php
// source: /var/www/clients/client3/web28/web/app/presenters/templates/User/detail.latte

class Template4386c6eb91bae54d535bf3601abd373a extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('4fdd4ce9cb', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb782c6e2e60_title')) { function _lb782c6e2e60_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb8a0123c102_content')) { function _lb8a0123c102_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;if ($userDat->photo) { ?>
