<?php
// source: /var/www/clients/client3/web28/web/app/AdminModule/templates/Article/updateArticle.latte

class Template8a17fa5fa7cfeae51fa1a92024c3009d extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('7cf2656537', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lbc2295c0a40_title')) { function _lbc2295c0a40_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>Upravit článek<?php
}}
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lba4704730d8_content')) { function _lba4704730d8_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><script>
...
// block _underSection
//
if (!function_exists($_b->blocks['_underSection'][] = '_lbd3a51cca7c__underSection')) { function _lbd3a51cca7c__underSection($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('underSection', FALSE)
?>    
...
//
if (!function_exists($_b->blocks['_underSubSectionSnippet'][] = '_lb5073587801__underSubSectionSnippet')) { function _lb5073587801__underSubSectionSnippet($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('underSubSectionSnippet', FALSE)
?>        
...
//
if (!function_exists($_b->blocks['_underSerialSnippet'][] = '_lb92b6f23940__underSerialSnippet')) { function _lb92b6f23940__underSerialSnippet($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('underSerialSnippet', FALSE)
?>            
...
// block script
//
if (!function_exists($_b->blocks['script'][] = '_lbe12bc20dd8_script')) { function _lbe12bc20dd8_script($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block hide
//
if (!function_exists($_b->blocks['hide'][] = '_lb0f7ab2dc21_hide')) { function _lb0f7ab2dc21_hide($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
