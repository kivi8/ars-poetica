<?php
// source: /var/www/clients/client12/web1/web/app/presenters/templates/@layout.latte

class Template2a2b1bf1e936c9d0545c335bb3cab29e extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('dbae40d55f', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb728cfa01fd_scripts')) { function _lb728cfa01fd_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block _menu
//
if (!function_exists($_b->blocks['_menu'][] = '_lb94c99718dc__menu')) { function _lb94c99718dc__menu($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('menu', FALSE)
...
// block _flashMessage
//
if (!function_exists($_b->blocks['_flashMessage'][] = '_lb08949a2b66__flashMessage')) { function _lb08949a2b66__flashMessage($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('flashMessage', FALSE)
