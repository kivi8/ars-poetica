<?php
// source: /var/www/clients/client12/web1/web/app/presenters/templates/SendArticle/default.latte

class Template8f845963ee975fec33c127d932a9ddc3 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('d8b7aee238', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb430d1dc713_title')) { function _lb430d1dc713_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb94611c7217_content')) { function _lb94611c7217_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
 ?>
...
// block _captcha
//
if (!function_exists($_b->blocks['_captcha'][] = '_lb5c2abbf3ad__captcha')) { function _lb5c2abbf3ad__captcha($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('captcha', FALSE)
...
// block script
//
if (!function_exists($_b->blocks['script'][] = '_lbed9237e7c4_script')) { function _lbed9237e7c4_script($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
