<?php
// source: /var/www/clients/client12/web1/web/app/AdminModule/templates/Article/addArticle.latte

class Template0a405a99371c9cc13e59a561f47c3a6d extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('637d94ce0d', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb17fad104af_title')) { function _lb17fad104af_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>Přidat článek<?php
}}
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb2ca985303d_content')) { function _lb2ca985303d_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
//
if (!function_exists($_b->blocks['_underSubSectionSnippet'][] = '_lba08108ff26__underSubSectionSnippet')) { function _lba08108ff26__underSubSectionSnippet($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('underSubSectionSnippet', FALSE)
?>        
...
//
if (!function_exists($_b->blocks['_underSerialSnippet'][] = '_lb5295c91291__underSerialSnippet')) { function _lb5295c91291__underSerialSnippet($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('underSerialSnippet', FALSE)
?>            
...
// block js
//
if (!function_exists($_b->blocks['js'][] = '_lbcbf11863c4_js')) { function _lbcbf11863c4_js($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block jsCallback
//
if (!function_exists($_b->blocks['jsCallback'][] = '_lb59c632d1ba_jsCallback')) { function _lb59c632d1ba_jsCallback($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block script
//
if (!function_exists($_b->blocks['script'][] = '_lb2266e05c45_script')) { function _lb2266e05c45_script($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
