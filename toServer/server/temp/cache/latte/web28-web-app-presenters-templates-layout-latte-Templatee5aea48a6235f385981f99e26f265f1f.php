<?php
// source: /var/www/clients/client3/web28/web/app/presenters/templates/@layout.latte

class Templatee5aea48a6235f385981f99e26f265f1f extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('709aabd7af', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbbc97ede2f4_scripts')) { function _lbbc97ede2f4_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block _menu
//
if (!function_exists($_b->blocks['_menu'][] = '_lbf8386ed955__menu')) { function _lbf8386ed955__menu($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('menu', FALSE)
...
// block _flashMessage
//
if (!function_exists($_b->blocks['_flashMessage'][] = '_lb4e9397635a__flashMessage')) { function _lb4e9397635a__flashMessage($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('flashMessage', FALSE)
