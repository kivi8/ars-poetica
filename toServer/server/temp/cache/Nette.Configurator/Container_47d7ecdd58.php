<?php
// source: /var/www/clients/client12/web1/web/app/config/config.neon 
// source: /var/www/clients/client12/web1/web/app/config/config.local.neon 

class Container_47d7ecdd58 extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			...
			'App\AdminModule\Presenters\CommentsPresenter' => array(array('application.1')),
			'App\AdminModule\Presenters\ArticlePresenter' => array(array('application.2')),
			'App\AdminModule\Presenters\UserPresenter' => array(array('application.3')),
			'App\AdminModule\Presenters\HomepagePresenter' => array(array('application.4')),
			'App\AdminModule\Presenters\NewsPresenter' => array(array('application.5')),
			'App\Presenters\SettingPresenter' => array(array('application.6')),
			'App\Presenters\SearchPresenter' => array(array('application.7')),
			'App\Presenters\ArtTeamPresenter' => array(array('application.8')),
			'App\Presenters\ErrorPresenter' => array(array('application.9')),
			'App\Presenters\ArticlePresenter' => array(array('application.10')),
			'App\Presenters\SendArticlePresenter' => array(array('application.11')),
			'App\Presenters\LogPresenter' => array(array('application.12')),
			'App\Presenters\MessagePresenter' => array(array('application.13')),
			'App\Presenters\UserPresenter' => array(array('application.14')),
			'App\Presenters\HomepagePresenter' => array(array('application.15')),
			'App\Presenters\CaptchaPresenter' => array(array('application.16')),
			'App\Presenters\MediaArchivePresenter' => array(array('application.17')),
		...
		'services' => array(
			...
			'application.1' => 'App\AdminModule\Presenters\CommentsPresenter',
			'application.10' => 'App\Presenters\ArticlePresenter',
			'application.11' => 'App\Presenters\SendArticlePresenter',
			'application.12' => 'App\Presenters\LogPresenter',
			'application.13' => 'App\Presenters\MessagePresenter',
			'application.14' => 'App\Presenters\UserPresenter',
			'application.15' => 'App\Presenters\HomepagePresenter',
			'application.16' => 'App\Presenters\CaptchaPresenter',
			'application.17' => 'App\Presenters\MediaArchivePresenter',
			'application.2' => 'App\AdminModule\Presenters\ArticlePresenter',
			'application.3' => 'App\AdminModule\Presenters\UserPresenter',
			'application.4' => 'App\AdminModule\Presenters\HomepagePresenter',
			'application.5' => 'App\AdminModule\Presenters\NewsPresenter',
			'application.6' => 'App\Presenters\SettingPresenter',
			'application.7' => 'App\Presenters\SearchPresenter',
			'application.8' => 'App\Presenters\ArtTeamPresenter',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/var/www/clients/client12/web1/web/app',
			'wwwDir' => '/var/www/clients/client12/web1/web/www',
			'debugMode' => FALSE,
			'productionMode' => TRUE,
			'environment' => 'production',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => '/var/www/clients/client12/web1/web/app/../temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/var/www/clients/client12/web1/web/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/clients/client12/web1/web/app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=c12arspoetica', 'c12krystof', 'heslojevesloK8',
			array('lazy' => TRUE));
	...
	{
		return new Container_47d7ecdd58_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('/var/www/clients/client12/web1/web/app/../temp/cache/latte');
...
final class Container_47d7ecdd58_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{

	private $container;


	public function __construct(Container_47d7ecdd58 $container)
	{
