...
class LogPresenter extends BasePresenter{
    ...
    /** @var \App\Model\CaptchaManager @inject */ 
    ...
    public function userLoginSucceeded(){
        ...
        $userDat = $this->user->getIdentity()->data;
            ...
            $this->goHome(Helper::combineUserName($userDat). ' byl přihlášen', 'Homepage:', ['log'=>'in'], 'success');
    }    
    ...
    public function actionOut(){
        ...
        $this->notLoggedUser();
        $this->user->logout();
        $this->goHome(Helper::combineUserName($this->user->getIdentity()->data). ' úspěšně odhlášen', 'Homepage:default', [], 'success');
    }
